 ...
 * LandFeatureCard
 * ----------------
 * Plot card used ONLY on /land/[slug] pages (the industry-style land
 * pages built from data/lands.json). Deliberately a separate component
 * from components/Landplotcard.jsx, which is used on another page —
 * keeping them separate means editing one can never break the other.
 *
 * Same cycling-image / Ken-Burns / save-heart behaviour as
 * Landplotcard.jsx, just under its own name and own file.
 *
