...
let HeroController = class HeroController {
    ...
    async setImages(images) {
        const updated = await this.heroService.setImages(Array.isArray(images) ? images : []);
...
], HeroController.prototype, "getImages", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], HeroController.prototype, "setImages", null);
exports.HeroController = HeroController = __decorate([
    (0, common_1.Controller)('api/v1/hero'),
