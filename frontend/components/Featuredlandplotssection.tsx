...
export const featuredLands = [
  ...
  },
  {
    ...
    images: ['/commercial1.jpg', '/commercial2.jpg', '/commercial3.jpg', '/commercial4.jpg'],
    rating: 4.8,
    ...
    <section className="relative py-32 bg-white z-30">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200 mb-6 transition-transform duration-300 hover:scale-105">
        ...
        <div className="text-center mt-12">
          <Link href="/landplots">
            <button className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-2xl font-bold shadow-xl transition-all duration-300 hover:shadow-emerald-500/30 hover:scale-105 active:scale-95">
